...
Route::prefix('teacher')->name('teacher.')->group(function () {
    Route::get('login', [TeacherAuthController::class, 'loginForm'])->name('login')->middleware('guest:teacher');
    Route::post('login', [TeacherAuthController::class, 'login']);
    Route::get('dashboard', [TeacherAuthController::class, 'dashboard'])->name('dashboard')->middleware('auth:teacher');
...
Route::prefix('student')->name('student.')->group(function () {
    ...
    Route::get('dashboard', [StudentAuthController::class, 'dashboard'])->name('dashboard')->middleware('auth:student');
